...
def run_selenium_tests(test_filter=None):
    ...
    cmd = ["uv", "run", "pytest", "tests/test_pdf_generation_e2e.py", "-v", "-m", "selenium"]
...
def main():
    parser = argparse.ArgumentParser(description="Run Selenium tests for PDF generation")
    ...
    parser.add_argument("--test-nan-bug", action="store_true", help="Test NaN% bug specifically")
    parser.add_argument("--url", default="http://localhost:8000", help="Server URL to test against")
