...
class TestPDFGeneration:
    ...
    def test_pdf_from_home_page(self, mock_celery, chrome_driver, app_url, sample_memo_text):
    ...
    def test_pdf_from_form_view(self, mock_celery, chrome_driver, app_url):
        ...
        # Submit the form
        submit_btn = self.wait_for_clickable(chrome_driver, By.CSS_SELECTOR, "input[type='submit'], button[type='submit']")
        submit_btn.click()
